...
const AppComponent: React.FC = () => {
  ...
  const toggleVideo = () => {
    const publishVideo = !ParticipantService.isMyVideoActive();
    OpenViduService.publishVideo(publishVideo);
  };

  const toggleAudio = () => {
    const publishAudio = !ParticipantService.isMyAudioActive();
    OpenViduService.publishAudio(publishAudio);
  };
    ...
    <div>
      {tokens && (
        <OpenViduVideoComponent tokens={tokens} toolbarDisplaySessionName={false}>
          <div slot="toolbarAdditionalButtons" style={{ textAlign: 'center' }}>
